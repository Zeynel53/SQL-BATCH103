...
--parent tabloda 105 olan bir deger olmadigindan dolayi cozulemez
--SORU 3: child tablosuna ted_vergino null olan veri girişi yapınız
insert into child values(null,4000,'bisiklet','zeynel');
--not:child tablosuna parentta olmasa bile null deger atanabiliyor
...
DELETE from parent where vergi_no=101; --silinemedi
...
delete from parent2;--on delete cascade oldugu icin parenti silebildik
--SORU2: parent2 tablosunu siliniz
drop table parent2 cascade;
--child tablo silinmeden cascade kullanarak parent tablo silindi
