--Subquery--NestedQuery--Altsorgu--İçiçe sorgu
...
SELECT bolum, kampus 
FROM bolumler WHERE bolum IN (SELECT bolum 
							  FROM ogrenciler 
							  WHERE puan>500) 
...
--bölümde okuyan öğrencilerin kaç farklı şehirden geldiğini listeleyiniz.(ilişkili-corralated)  
SELECT bolum,(SELECT COUNT(sehir)
			  FROM ogrenciler o
